...
void Paladin::specialMove() {
    ...
    while (surrounded(userInput1) || !board->isOccupied(userInput1) || (userInput1 < 0 || userInput1 > 9) ) {
        cout << invalidMark << endl;
        while (!(cin >> userInput1))
        {
            cin.clear();
...
bool Paladin::adjacentTile(int input1, int input2) //Is there a more efficient way to do this? I'd very much love to know
{
    ...
    if (input1 == 2 && (input2 == 1 || input2 == 3 || input2 == 4 || input2 == 5 || input2 == 6)) {
        return true;
    }
    if (input1 == 3 && (input2 == 2 || input2 == 5 || input2 == 6)) {
        return true;
    }
    if (input1 == 4 && (input2 == 1 || input2 == 2 || input2 == 5 || input2 == 7 || input2 == 8)) {
        return true;
    }
    if (input1 == 5 && input2 != 5) {
        return true;
    }
    if (input1 == 6 && (input2 == 2 || input2 == 3 || input2 == 5 || input2 == 8 || input2 == 9)) {
        return true;
    }
    if (input1 == 7 && (input2 == 4 || input2 == 5 || input2 == 8)) {
        return true;
    }
    if (input1 == 8 && (input2 == 4 || input2 == 5 || input2 == 6 || input2 == 7 || input2 == 9)) {
        return true;
    }
    if (input1 == 9 && (input2 == 5 || input2 == 6 || input2 == 8)) {
        return true;
    }
    else {
        return false;
...
bool Paladin::surrounded(int input1)
{
    if (input1 == 1 && board->getValue(2) != "2" && board->getValue(4) != "4" && board->getValue(5) != "5") {
        return true;
    }
    
    if (input1 == 2 && board->getValue(1) != "1" && board->getValue(3) != "3" && board->getValue(4) != "4" && board->getValue(5) != "5" && board->getValue(6) != "6") {
        return true;
    }
    
    if (input1 == 3 && board->getValue(2) != "2" && board->getValue(5) != "5" && board->getValue(6) != "6") {
        return true;
    }
    
    if (input1 == 4 && board->getValue(1) != "1" && board->getValue(2) != "2" && board->getValue(5) != "5" && board->getValue(7) != "7" && board->getValue(8) != "8") {
        return true;
    }
    
    if (input1 == 6 && board->getValue(2) != "2" && board->getValue(3) != "3" && board->getValue(5) != "5" && board->getValue(8) != "8" && board->getValue(9) != "9") {
        return true;
    }
    
    if (input1 == 7 && board->getValue(4) != "4" && board->getValue(5) != "5" && board->getValue(8) != "8") {
        return true;
    }
    
    if (input1 == 8 && board->getValue(4) != "4" && board->getValue(5) != "5" && board->getValue(6) != "6" && board->getValue(7) != "7" && board->getValue(9) != "9") {
        return true;
    }
    
    if (input1 == 9 && board->getValue(5) != "5" && board->getValue(6) != "6" && board->getValue(8) != "8") {
        return true;
    }
